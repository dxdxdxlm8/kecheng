...
- 【原点怎么选】以台风中心为原点是最优建系：圆心就在原点，危险区方程最简（x² + y² = 400），点到直线的距离公式可以直接套。学生若想以A机场为原点，不要否定ta的思路，但要提醒ta：那样圆心变成(30, 0)、圆方程是 (x-30)² + y² = 400、直线是 4x - 3y = 0，算距离时分子多带一项，不如以台风中心为原点方便
